    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'DM Sans', sans-serif", background: c.bgPrimary, color: c.text, position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            borderRadius: 99, padding: '3px 10px 3px 6px', fontSize: 11, color: '#818cf8', marginBottom: 20
          }}>
          ...
          <div style={{ background: c.bgCard, border: '1px solid ' + c.borderStrong, borderRadius: 16, padding: 20, marginTop: 36 }}>
            ...
            <div style={{ fontSize: 11, color: c.textFaint, display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
              <span>Profile complete</span><span>78%</span>
            </div>
      ...
      <div style={{ flex: 1, background: c.bgSecondary, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 48 }}>
        <div style={{ width: '100%', maxWidth: 380 }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 28, fontWeight: 700, letterSpacing: -0.5, marginBottom: 6, color: c.text }}>Welcome back</h2>
          <p style={{ fontSize: 14, color: c.textMuted, marginBottom: 28, fontWeight: 300 }}>Login to continue building your portfolio</p>

          <div style={{ display: 'flex', background: c.bgCard, border: '1px solid ' + c.borderStrong, borderRadius: 10, padding: 4, marginBottom: 28 }}>
            <div style={{ flex: 1, padding: '8px', textAlign: 'center', fontSize: 13, fontWeight: 500, background: c.accentBg, borderRadius: 7, color: c.accentText }}>Login</div>
            <div style={{ flex: 1, padding: '8px', textAlign: 'center', fontSize: 13, fontWeight: 500, color: c.textFaint, cursor: 'pointer' }} onClick={() => navigate('/register')}>Register</div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              {loading ? 'Logging in...' : 'Login to Portify'}
            </button>
          </form>
...
>
  ...
  Continue with Google
          ...
          <p style={{ textAlign: 'center', marginTop: 24, fontSize: 13, color: c.textFaint }}>
            ...
            <span onClick={() => navigate('/register')} style={{ color: c.accentText, cursor: 'pointer' }}>Register free</span>
          </p>
        </div>
      </div>
    </div>
